...
mongoose
.connect(
    `mongodb+srv://${dbUser}:${dbPassword}@nodejsmongodb.yjfwrdy.mongodb.net/?retryWrites=true&w=majority`
    )
    .then(() => {
    app.listen(3000)
...
//check if user exists / verificar se o usuário existe
    ...
    //create password - criação de senha
...
//check if passowrd match / verificação se o usuário encontra-se atrelado ao banco
